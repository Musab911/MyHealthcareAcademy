      ...
      <div class="content-col">
        ...
        <div class="row">
          <div class="card">
            ...
            <p>Our program can be taken in 14 of the world’s most exciting cities. Pick a city that suits your career goals.</p>
          </div>
          <div class="card">
            <div class="icon-bg">
            ...
            <p>If you are eligible you will be invited to attend an admission interview to discuss your program further.</p>
          </div>
          <div class="card">
            <div class="icon-bg">
            ...
            <h3>3. Get Excited!</h3>
            <p>As soon as you are accepted we’ll begin preparing your program. Starting with understanding your goals and matching your profile with one of our host company partners.</p>
          </div>
        </div>

      </div>
    </div>
    <div class="container-wrapper-col"  style="background-image:linear-gradient(
      ...
      <div class="top-content">
        ...
        <div class="top-aligned" style="width: 40%">
          <p>
            Our programs span 14 vibrant cities worldwide, each offering unique opportunities for growth and cultural immersion. These carefully chosen locations enhance your educational journey. Join us to broaden your horizons and explore new possibilities.
          </p>
        </div>
      </div>
      <div class="content slider">
        <div class="slider-card">
          <img src="/assets/images/tokyo-tower.png" alt="" class="card-image">
