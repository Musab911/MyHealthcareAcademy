          ...
          <div class="custom-content">
            <div class="custom-card-body">
              ...
              <form action="{{ route('internships.store') }}" method="POST">
                ...
                <div class="form-group">
                  <label for="duration" class="custom-label">Duration (weeks):</label>
                  <input type="range" id="duration" name="duration" class="custom-range" min="4" max="24" step="4" value="4" required>
                  <span id="selectedWeeks">4</span> weeks
                  <!-- Hidden input field to store selected duration value -->
                  <input type="hidden" id="duration_value" name="duration_value" value="4">
                </div>
                <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    // Set selected industry value to hidden input when option is selected
    $('#industry').change(function() {
      var selectedIndustry = $(this).val();
      $('#selected_industry').val(selectedIndustry);
    });
  });
</script>
<script>
